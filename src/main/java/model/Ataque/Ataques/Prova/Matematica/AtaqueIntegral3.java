...
public class AtaqueIntegral3 extends Ataque {
    ...
    private Projetil integralCentro3 = null;
    private Projetil integralHitbox = null;
    private Projetil integralHitbox2 = null;
    private Projetil integralHitbox3 = null;
    ...
    protected void logicaAtaque(float dt) {
        ...
        if (!integralSpawnado) {
            ...
            if (integralCentro != null && integralCentro2 != null && integralCentro3 != null) {
                ...
                integralCentro3.setVelocidadeAngular(0f);
                integralCentro.setPersistente(true);
                integralCentro2.setPersistente(true);
                integralCentro3.setPersistente(true);
            }
            ...
            if (integralHitbox3 != null) {
                // começa sem rotação e sem dano
                integralHitbox3.setVelocidadeAngular(0f);
                integralHitbox3.setDanoShield(0);
                integralHitbox3.setDanoNota(0f);
                integralHitbox3.setPersistente(true);
            }
        ...
        if (!integralAtivado && tempoDecorrido >= gracePeriod) {
            ...
            if (integralCentro3 != null) integralCentro3.setVelocidadeAngular(velAngIntegral);
            if (integralHitbox != null) {
                integralHitbox.setVelocidadeAngular(velAngIntegral);
                integralHitbox.setDanoShield(2);
                integralHitbox.setDanoNota(1.75f);   // ativa o dano de nota
            }
            if (integralHitbox2 != null) {
                integralHitbox2.setVelocidadeAngular(velAngIntegral);
                integralHitbox2.setDanoShield(2);
                integralHitbox2.setDanoNota(1.75f);   // ativa o dano de nota
            }
            if (integralHitbox3 != null) {
                integralHitbox3.setVelocidadeAngular(velAngIntegral);
                integralHitbox3.setDanoShield(2);
                integralHitbox3.setDanoNota(1.75f);   // ativa o dano de nota
            }
        ...
        float interval = (2.4f) / (dificuldade / 10f);
