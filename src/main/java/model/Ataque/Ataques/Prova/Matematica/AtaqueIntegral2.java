...
public class AtaqueIntegral2 extends Ataque {
    ...
    protected void logicaAtaque(float dt) {
        ...
        if (!integralGerada) {
            ...
            if (centroIntegral != null && centroIntegral2 != null) {
        ...
        if (!integralAtivada && tempoDecorrido >= periodoGraca) {
            ...
            if (hitboxIntegral != null) {
                ...
                hitboxIntegral.setDanoNota(1.25f);   // ativa o dano de nota
            }
            if (hitboxIntegral2 != null) {
                hitboxIntegral2.setVelocidadeAngular(velAngIntegral);
                hitboxIntegral2.setDanoShield(1);
                hitboxIntegral2.setDanoNota(1.25f);   // ativa o dano de nota
            }
        ...
        float intervalo = 1.8f / (dificuldade / 10f);
