...
public class ProjetilQuePreve implements ComportamentoProjetil, ComportamentoAoColidirComPlayer {
    ...
    private final float tempoPrevisaoMax;

    public ProjetilQuePreve(float velocidadeMaxima, float forcaInercia, float tempoPrevisaoMax) {
        this.velocidadeMaxima = velocidadeMaxima;
        this.forcaInercia = forcaInercia;
        this.tempoPrevisaoMax = tempoPrevisaoMax;
    }
    ...
    public void executar(Projetil projetil, float dt) {
        if (projetil.getTarget() != null) {
            ...
            float distancia = projetil.getTarget().getCentro().distancia(projetil.getCentro());
            ...
            tempoInterceptacao = Math.min(tempoInterceptacao, tempoPrevisaoMax);
